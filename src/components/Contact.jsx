          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <a href="mailto:ubamadupossible@gmail.com" className="flex items-center gap-4 text-slate-300 hover:text-primary transition-colors group">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-surface/50 p-6 md:p-8 rounded-xl border border-white/5"
            >
              <form
                ...
                onSubmit={(e) => {
                  ...
                  window.location.href = `mailto:ubamadupossible@gmail.com?subject=Portfolio Contact from ${encodeURIComponent(name)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\n${message}`)}`;
                }}
              >
                ...
                <button type="submit" className="mt-4 flex items-center justify-center gap-2 w-full py-3 bg-primary text-bg-dark font-bold rounded hover:bg-primary-light transition-colors shadow-[0_0_15px_rgba(14,165,233,0.3)]">
